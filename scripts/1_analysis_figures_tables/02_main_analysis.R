...
#saveRDS(dat_shifted_5, here::here("data/analysis_data/analysis_data_shifted_5.rds"))
...
for (i in 14:5)
  {
    ...
    # )
    # 
    # saveRDS(results_shift_obs, here::here(paste0("results_r1/results_obs_day_", i, ".rds")))
    ...
    saveRDS(results_shift_5, here::here(paste0("results_r1/results_shift_5_day_", i, ".rds")))
    ...
    saveRDS(results_shift_3, here::here(paste0("results_r1/results_shift_3_day_", i, ".rds")))
    ...
    saveRDS(results_shift_always, here::here(paste0("results_r1/results_shift_always_day_", i, ".rds")))
  }

...
dat <- readRDS(here::here("data/analysis_data/analysis_data.rds")) |>
  mutate(follows_dtr_5_day_1 = ifelse(max_cows_1 >= 5 & max_cows_eligible_1 == 1 & max_cows_missing_indicator_1 == 0 & adj_1 == 1
                        , 1, 0),

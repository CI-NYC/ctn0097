...
for (j in 1:1)
{
  for (i in 14:14)
  {
    ...
    # )
    # 
    # saveRDS(results_shift_obs, here::here(paste0("results_alt/results_obs_day_", i, "_", j, ".rds")))
    ...
    # )
    # 
    # saveRDS(results_shift_5, here::here(paste0("results_alt/results_shift_5_day_", i, "_", j, ".rds")))
    ...
    # )
    # 
    # saveRDS(results_shift_3, here::here(paste0("results_alt/results_shift_3_day_", i, "_", j, ".rds")))
    ...
    saveRDS(results_shift_always, here::here(paste0("results_alt/results_shift_always_day_", i, "_", j, ".rds")))
  }
}
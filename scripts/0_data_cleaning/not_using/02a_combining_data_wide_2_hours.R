...
dat_long <- readRDS(here::here("data/analysis_data/max_cows_data_2_hours.rds")) |>
  mutate(A1 = case_when(day_post_consent == naltrexone_injection_day & pre_injection_clonidine >= 0.1 ~ 1, # if injection day, only look at pre-injection 
                        is.na(max_cows) & DMCLDDTL >= 0.1 ~ 1, # if cows missing then do all medications over the day
         ...
         A2 = case_when(day_post_consent == naltrexone_injection_day & pre_injection_clonazepam >= 1 ~ 1,  # if injection day, only look at pre-injection 
                        is.na(max_cows) & DMCZPDTL >= 1 ~ 1, # if cows missing then do all medications over the day
  ...
  mutate(max_cows = ifelse(is.na(max_cows), 0, max_cows),
         max_cows_ineligible = ifelse(is.na(max_cows_ineligible), 0, max_cows_ineligible)) # replacing max cows with 0 

#saveRDS(dat_long, "data/analysis_data/dat_long.rds")

dat <- dat_long |>
  pivot_wider(names_from = day_post_consent, values_from = c(max_cows, max_cows_time, max_cows_ineligible, ends_with("inelig"), A1, A2, A3, L1, L2, adj)) |>
  mutate_at(vars(starts_with("A"), starts_with("L")), ~ if_else(is.na(.), 0, .)) |>
...
completed_datasets <- lapply(completed_datasets, function(dat_final) {
  dat_final |>
    ...
    select(PATID, PROTSEG, received_naltrexone_injection, age, DESEX, is_hispanic,
           ...
           max_cows_1, max_cows_ineligible_1, L1_1, L2_1, adj_1, C_1, Y_1,
           max_cows_2, max_cows_ineligible_2, L1_2, L2_2, adj_2, C_2, Y_2,
           max_cows_3, max_cows_ineligible_3, L1_3, L2_3, adj_3, C_3, Y_3,
           max_cows_4, max_cows_ineligible_4, L1_4, L2_4, adj_4, C_4, Y_4,
           max_cows_5, max_cows_ineligible_5, L1_5, L2_5, adj_5, C_5, Y_5,
           max_cows_6, max_cows_ineligible_6, L1_6, L2_6, adj_6, C_6, Y_6,
           max_cows_7, max_cows_ineligible_7, L1_7, L2_7, adj_7, C_7, Y_7,
           max_cows_8, max_cows_ineligible_8, L1_8, L2_8, adj_8, C_8, Y_8,
           max_cows_9, max_cows_ineligible_9, L1_9, L2_9, adj_9, C_9, Y_9,
           max_cows_10, max_cows_ineligible_10, L1_10, L2_10, adj_10, C_10, Y_10,
           max_cows_11, max_cows_ineligible_11, L1_11, L2_11, adj_11, C_11, Y_11,
           max_cows_12, max_cows_ineligible_12, L1_12, L2_12, adj_12, C_12, Y_12,
           max_cows_13, max_cows_ineligible_13, L1_13, L2_13, adj_13, C_13, Y_13,
           max_cows_14, max_cows_ineligible_14, L1_14, L2_14, adj_14, C_14, Y_14,
           C_6, Y_6,
           C_7, Y_7,
           C_8, Y_8,
           C_9, Y_9,
...
completed_datasets <- lapply(completed_datasets, function(data){
  ...
  # mutate(C_3 = ifelse(Y_2 == 1, NA, C_3),
  #        C_4 = ifelse(Y_3 == 1, NA, C_4),
  #        C_5 = ifelse(Y_4 == 1, NA, C_5),
  #        C_6 = ifelse(Y_5 == 1, NA, C_6),
  #        C_7 = ifelse(Y_6 == 1, NA, C_7),
  #        C_8 = ifelse(Y_7 == 1, NA, C_8),
  #        C_9 = ifelse(Y_8 == 1, NA, C_9),
  #        C_10 = ifelse(Y_9 == 1, NA, C_10),
  #        C_11 = ifelse(Y_10 == 1, NA, C_11),
  #        C_12 = ifelse(Y_11 == 1, NA, C_12),
  #        C_13 = ifelse(Y_12 == 1, NA, C_13),
  #        C_14 = ifelse(Y_13 == 1, NA, C_14)
  #        )
  #|>
  # mutate(adj_2 = ifelse(C_2 == 0, NA, adj_2),
  #        max_cows_2 = ifelse(C_2 == 0, NA, max_cows_2),
  #        L1_2 = ifelse(C_2 == 0, NA, L1_2),
  #        L2_2 = ifelse(C_2 == 0, NA, L2_2),
  #        adj_3 = ifelse(C_3 == 0, NA, adj_3),
  #        max_cows_3 = ifelse(C_3 == 0, NA, max_cows_3),
  #        L1_3 = ifelse(C_3 == 0, NA, L1_3),
  #        L2_3 = ifelse(C_3 == 0, NA, L2_3),
  #        adj_4 = ifelse(C_4 == 0, NA, adj_4),
  #        max_cows_4 = ifelse(C_4 == 0, NA, max_cows_4),
  #        L1_4 = ifelse(C_4 == 0, NA, L1_4),
  #        L2_4 = ifelse(C_4 == 0, NA, L2_4),
  #        adj_5 = ifelse(C_5 == 0, NA, adj_5),
  #        max_cows_5 = ifelse(C_5 == 0, NA, max_cows_5),
  #        L1_5 = ifelse(C_5 == 0, NA, L1_5),
  #        L2_5 = ifelse(C_5 == 0, NA, L2_5)
  #        )
})

saveRDS(completed_datasets, here::here("data/analysis_data/completed_datasets_2_hours.rds"))


# checking positivity violations of smaller variables
# results <- list()
# 
# for (i in 1:8)
# {
#   results[[i]] <- dat_final |>
#     filter(DEAMEIND == 1, !!sym(paste0("C_", i)) == 1) |>
#     group_by(#!!sym(paste0("max_cows_", i)) >=8 & !!sym(paste0("max_cows_ineligible_", i)) == 0 & !!sym(paste0("L2_", i)) == 0, 
#       !!sym(paste0("adj_", i))) |>
#     summarize(count = n())
# }
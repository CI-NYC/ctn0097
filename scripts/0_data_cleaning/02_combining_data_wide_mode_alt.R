...
dat_long <- readRDS(here::here("data/analysis_data/max_cows_data_alt.rds")) |>
  ...
  mutate(#naltrexone_injection_day_shift = case_when(naltrexone_injection_day == day_post_consent & is.na(max_cows_time) & pre_injection_clonidine == 0 & pre_injection_clonazepam == 0 & A3 == 0 ~ 1, # if no cows on day x, then injection counted as previous day
          #                                          TRUE ~ 0),
...
saveRDS(dat, here::here("data/analysis_data/pre_imputed_analysis_data_alt.rds"))
...
saveRDS(dat, here::here("data/analysis_data/analysis_data_alt.rds"))
...
dat_long <- readRDS(here::here("data/analysis_data/max_cows_data_alt.rds")) |>
  ...
  select(PATID, PROTSEG, naltrexone_injection_day, naltrexone_injection_time, end_induction_day, 
         received_naltrexone_injection, days_from_admission_to_consent, day_post_consent, max_cows, max_cows_time, max_cows_ineligible, ends_with("inelig"), A1, A2, A3, adj, L1, L2, end_shift) |>
  group_by(PATID) |>

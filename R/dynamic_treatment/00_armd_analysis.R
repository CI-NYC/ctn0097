...
saveRDS(results, "data/results_10.rds")
...
saveRDS(results_5, "data/results_5.rds")

trt10_d <- readRDS("data/results_10.rds")
trt5_d <- readRDS("data/results_5.rds")
obs_d <- readRDS("data/results_origin.rds")

trt10_c <- readRDS("data/results_10_armc.rds")
trt5_c <- readRDS("data/results_5_armc.rds")
obs_c <- readRDS("data/results_origin_armc.rds")

trt10_comb <- readRDS("data/results_10_comb.rds")
trt5_comb <- readRDS("data/results_5_comb.rds")
obs_comb <- readRDS("data/results_origin_comb.rds")


# estimating difference

#arm d
lmtp_contrast(trt10_d, ref = obs_d)
lmtp_contrast(trt10_d, ref = trt5_d)
lmtp_contrast(trt5_d, ref = obs_d)

#arm c
lmtp_contrast(trt10_c, ref = obs_c)
lmtp_contrast(trt10_c, ref = trt5_c)
lmtp_contrast(trt5_c, ref = obs_c)

#combined
lmtp_contrast(trt10_comb, ref = obs_comb)
lmtp_contrast(trt10_comb, ref = trt5_comb)
lmtp_contrast(trt5_comb, ref = obs_comb)

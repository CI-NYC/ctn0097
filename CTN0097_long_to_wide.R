...
measures <- data[, c("PATID","VISNO_num","A1","A2")][COWS_SCORE, on = c("PATID", "VISNO_num")]
...
additional_vars <- data.frame(C.0 = as.numeric(!is.na(data_wide$Y.1)),
...
write.csv(data_wide, "/Users/anton/Library/CloudStorage/OneDrive-ColumbiaUniversityIrvingMedicalCenter/Q1_2024/CTN0097/ctn0097dat_wide.csv")
